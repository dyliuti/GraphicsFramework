...
namespace render::gl {
class RENDER_EXPORT Buffer : public OpenGLBase {
public:
    Buffer();
...
class RENDER_EXPORT ElementBuffer : public render::gl::Buffer {
public:
    using Buffer::Buffer;
...
class RENDER_EXPORT VertexBuffer : public render::gl::Buffer {
public:
    using Buffer::Buffer;
